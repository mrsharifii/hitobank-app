...
const Hero = () => {
  return (
    <section id='home' className={`flex mt-10 md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 my-6`}>
      ...
      <div className={`${styles.flexCenter} flex flex-1 md:my-0 my-10 relative`}>
        <img src={robot} alt='billing' className='my-10 w-[90%] h-[90%] relative z-[5]'/>

        <div className='absolute z-[0] w-[20%] h-[15%] top-0 pink__gradient' />
        <div className='absolute z-[1] w-[50%] h-[50%] rounded-full bottom-40' />
        <div className='absolute z-[0] w-[30%] h-[20%] bottom-20 blue__gradient' />
      </div>
